...
Solusi with Ollama supports internet search which can be used with your LLM. It works similarly to ChatGPT's internet search.
...
When you enable internet search and input a webpage URL into the input box and send it, Solusi with Ollama will visit the website and extract the text from it. Then it will send the text to the LLM.
